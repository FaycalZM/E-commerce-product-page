...
export const CartIcon = ({ color }: CartIconProps) => {
    const hover = color == "#69707D" ? true : false;
    return (
        <svg className={`fill-[${color}] ${hover ? 'hover:fill-black' : ""} transition`} width="22" height="20" xmlns="http://www.w3.org/2000/svg">
...
export const CloseIcon = () => {
    return (
        <svg
            className="fill-grayish-blue hover:fill-primary-orange transition"
...
export const DeleteIcon = () => {
    return (
        <svg
            className="fill-grayish-blue hover:fill-dark-grayish-blue transition"
            width="14" height="18" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
            <defs>
...
export const NextIcon = () => {
    return (
        <svg className="stroke-[#1D2026] " width="13" height="18" xmlns="http://www.w3.org/2000/svg">
...
export const PreviousIcon = () => {
    return (
        <svg className="stroke-[#1D2026] " width="12" height="18" xmlns="http://www.w3.org/2000/svg">
            <path d="M11 1 3 9l8 8" stroke-width="3" fill="none" fillRule="evenodd" />
        </svg>
    )
}
